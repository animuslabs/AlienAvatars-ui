<template lang='pug'>
q-img(v-if="imgSrc" noTransition width="80px" :src="imgSrc" placeholder-src="/loadingCard.png" style="width:82px; height:120px; margin:5px; filter: drop-shadow(1px 5px 5px rgba(1,1,1,.2) );")
...
export default defineComponent({
  ...
  async mounted() {
    await sleep(20000)
    this.atomic.getTemplate(this.templateId)
  },
  unmounted() {
    return
  },
