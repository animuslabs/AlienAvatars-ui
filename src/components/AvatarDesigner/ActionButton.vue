...
.row.items-center.full-width(style="height:70px")
  ...
  div(v-else)
    q-btn.pulse(size="xl" v-if="!existingTemplateData" color="primary" :label="btnLabel" :disabled="!isAllowedToCreateTemplate" key="create_template" @click="startMinting()" :loading="buttonsLoading" )
